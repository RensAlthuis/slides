...
function drawOutLineAnim(screen, canvas, outline, target, fullImg, animator, speed = 1) {
    if (!(outline.length > 0)) {
...
module.exports = class GBF {
    ...
    animate(screen, canvas) {
        ...
        this.animator = window.setInterval(drawOutLineAnim, 1, screen, canvas, this.outlines, noutImg, fullimg, 1);
    }
}